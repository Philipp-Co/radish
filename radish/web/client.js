...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['zuc_on_response'] != 'undefined', 'missing Wasm export: zuc_on_response');
  assert(typeof wasmExports['zuc_on_connection_state'] != 'undefined', 'missing Wasm export: zuc_on_connection_state');
  ...
  _zuc_on_response = Module['_zuc_on_response'] = createExportWrapper('zuc_on_response', wasmExports['zuc_on_response'], 2);
  _zuc_on_connection_state = Module['_zuc_on_connection_state'] = createExportWrapper('zuc_on_connection_state', wasmExports['zuc_on_connection_state'], 1);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createZucchiniModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createZucchiniModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createZucchiniModule);
